# This code has been adapted from gmplot: https://github.com/vgm64/gmplot

import math
import requests
import json
import os
from static.color_dicts import mpl_color_map, html_color_codes
...
class GoogleMapPlotter(object):
    ...
    def marker(self, lat, lng, title="no implementation", color='#FF0000', c=None):
        if c:
            color = c
    ...
    def scatter(self, lats, lngs, titles, color=None, size=None, marker=True, c=None, s=None, **kwargs):
        color = color or c
    ...
    def heatmap(self, lats, lngs, threshold=10, radius=10, gradient=None, maxIntensity=10, opacity=0.6, dissipating=True):
        """
        :param lats: list of latitudes
        :param lngs: list of longitudes
        :param threshold:
        :param maxIntensity: sets the maximum intensity as opposed to using the max value
...
if __name__ == '__main__':
    mymap = GoogleMapPlotter(37.428, -122.145, 16, apikey='AIzaSyD3vBwndDQ1bj2bfbUth1vxoch2S_HEKhA')
    ...
    scatter_path = ([37.424435, 37.424417, 37.424417],
                    [-122.142048, -122.141275, -122.140503])
    mymap.scatter(scatter_path[0], scatter_path[1], titles=['a','b','c'], c='r', marker=True)
    mymap.draw('./static/mymap.html')
